...
def clean_data(gdf,keep=True, *argv):    #Possibilité de garder certaines colonnes
    if keep:
...
#Test avant traitement geopandas overlay
...
#Calcul du coeficient d'emprise au sol
